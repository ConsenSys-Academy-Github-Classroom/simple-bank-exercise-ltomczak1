...
contract SimpleBank {
    ...
    function enroll() public returns (bool){
      ...
      if (enrolled[msg.sender] == false) {
        require(enrolled[msg.sender] == false, "User enrolled already!");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, "Your requested withdrawal is more than your available balance");
